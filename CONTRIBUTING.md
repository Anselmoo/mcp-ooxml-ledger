...
Publishing uses OIDC trusted publishing. There is no API token in this repository, and
none should ever be added. The trusted-publisher registration is bound to the workflow
